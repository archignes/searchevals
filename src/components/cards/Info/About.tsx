...
import { SearchevalTitle } from "@/src/components/header/Header"
...
const AboutCard = () => {
  ...
  const uniqueSystemsCount = new Set(data.flatMap((evalItem: EvalItem) => evalItem.systems)).size;
  const evals = data;
  return (
    <>
      <Card className='w-9/10 border-none shadow-none mx-auto'>
        <CardContent >
          <div className="space-y-4">
            <section id="about" className="p-1 mt-5">
            ...
            <section id="why" className="p-1 mt-2">
